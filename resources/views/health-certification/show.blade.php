                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h1 style="margin-top: 20px; margin-left: auto; margin-right: auto; text-transform: uppercase">Phiếu khám bệnh</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <label>{{ isset($data_edit->medicalService) ? $data_edit->medicalService->name : '' }}</label>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="font-weight-bold">{{ $data_edit->consultingRoom->address }}</label>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="font-weight-bold">{{ $data_edit->start_date }}</label>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <label>Thời gian khám thực tế: </label>
                                    </div>

                                    <div class="col-sm-4">
                                        <label class="font-weight-bold">{{ $data_edit->end_date }}</label>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="font-weight-bold">{{ isset($data_edit->user) ?  $data_edit->user->name : '' }}</label>
                                    </div>
                        ...
                        @if (in_array($data_edit->status, [1, 2]))
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-3">Thông tin chuẩn đoán ban đầu</h4>
                                <div class="col-sm-10">
                                    {!! $data_edit->diagnostic !!}
                                </div>
                            </div>
                        </div>
                        @endif
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <label>{!! $data_edit->re_examination_date !!}</label>
                                        </div>
                                    </div>
                                </div>
