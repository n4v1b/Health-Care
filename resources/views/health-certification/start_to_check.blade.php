...
@section('title') Xác nhận bắt đầu khám bệnh @endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Xác nhận bắt đầu khám bệnh</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Xác nhận bắt đầu khám bệnh</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="{{ route('health_certifications.update-start-to-check', $data_edit->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="title">Thông tin <span class="text-danger">*</span></label>
                                        <textarea id="diagnostic" class="summernote mb-2" name="diagnostic"></textarea>
                                        {!! $errors->first('diagnostic', '<span class="error mt-1 d-block">:message</span>') !!}
                                    </div>
