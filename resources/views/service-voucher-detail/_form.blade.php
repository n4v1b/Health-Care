...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group">
            <label for="result">File Kết quả </label>
            <input type="file" name="result_file" class="form-control" placeholder="File kết quả">
            {!! $errors->first('result_file', '<span class="error mt-1 d-block">:message</span>') !!}
        </div>
    </div>
