...
@section('title') Thêm lịch khám @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm lịch khám</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('booking.index') }}" title="Thêm lịch khám" data-toggle="tooltip" data-placement="top">Thêm lịch khám</a></li>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $(function () {
            var urlGetTimes = '{{ route("booking.load.list.times") }}';
