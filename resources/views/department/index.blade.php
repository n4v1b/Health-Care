                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('department.index') }}">
                                    <div class="row mb-2">
                                        ...
                                        @can('Tạo mới phòng ban')
                                            <div class="col-sm-7">
                                                <div class="text-sm-right">
                                                    <a href="{{ route('department.create') }}" class="text-white btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Thêm phòng ban</a>
                                                </div>
                                            </div><!-- end col-->
                                        @endcan
                                    </div>
                                                    ...
                                                    <ul class="list-inline font-size-20 contact-links mb-0">
                                                        @can('Chỉnh sửa phòng ban')
                                                            <li class="list-inline-item px">
                                                                <a href="{{ route('department.edit', $department->id) }}" data-toggle="tooltip" data-placement="top" title="Sửa"><i class="mdi mdi-pencil text-success"></i></a>
                                                            </li>
                                                        @endcan
