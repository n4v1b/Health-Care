...
@section('title') Cập nhật phòng ban @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật phòng ban</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('department.index') }}" title="Quản lý phòng ban" data-toggle="tooltip" data-placement="top">Quản lý phòng ban</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('department.update', $data_edit->id) }}" enctype="multipart/form-data">
                                    @method('PUT')
