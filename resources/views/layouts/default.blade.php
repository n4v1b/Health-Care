...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style type="text/css">
			...
			.swal-modal.background-none{
				background: none;
			}
			.swal-modal.background-none > .swal-icon > img{
				height: 100px;
				width: 100px;
			}
        </style>
    ...
    <body data-sidebar="dark">
        ...
        <div id="layout-wrapper">
            ...
            <header id="page-topbar">
                <div class="navbar-header">
                    <div class="d-flex">
                        <!-- LOGO -->
                        <div class="navbar-brand-box" style="padding: 0px !important;">
                            ...
                            <a href="{{ route('dashboard') }}" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('images\logo.jpg') }}" alt="" height="71">
                                </span>
                            </a>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function loading() {
	            swal({
	                title: "",
	                icon: "{{asset('images/loading2.gif')}}",
	                imageHeight: 80,
	                imageWidth: 80,
	                buttons: false,
		    ...
		    $('button[type="submit"]').click(function () {
                ...
                if (submit_val !== 'export' && submit_val !== 'report' && submit_val !== 'update' && submit_val !== 'create') {
                    loading();
                }

            });
            var loadListTimes = "{{ route('load.list.times') }}"
        </script>
