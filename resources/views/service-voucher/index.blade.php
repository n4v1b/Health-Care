...
@section('title') Quản lý phiếu cận lâm sàng @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Danh sách phiếu cận lâm sàng</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);" title="Quản lý" data-toggle="tooltip" data-placement="top">Quản lý</a></li>
                                    <li class="breadcrumb-item active">Danh sách phiếu cận lâm sàng</li>
                                </ol>
                            </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="text-sm-right">
                                                <a href="{{ route('service_vouchers.create') }}" class="text-white btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Thêm phiếu cận lâm sàng</a>
                                            </div>
                                        </div><!-- end col-->
                                        @endcan
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($service_vouchers as $service_voucher)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ isset($service_voucher->patient) ? $service_voucher->patient->name : '' }}
                                                    </td>
                                                    <td>
                                                        {{ isset($service_voucher->medicalService) ? $service_voucher->medicalService->name : '' }}
                                                    </td>
                                                    <td>
                                                        @if(isset($service_voucher->healthCertification))
                                                        <a href="{{ route('health_certifications.show', $service_voucher->healthCertification->id) }}">
                                                            {{ isset($service_voucher->healthCertification) ? $service_voucher->healthCertification->code : '' }}
                                                        </a>
                                                        @endif
                                                    </td>
                                                    <td>{{ isset($service_voucher->user) ? $service_voucher->user->name : '' }}</td>
