...
@section('title') Thêm phiếu cận lâm sàng @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm phiếu cận lâm sàng</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Thêm phiếu cận lâm sàng</li>
                                </ol>
                            </div>
