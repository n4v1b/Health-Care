                                        ...
                                        <tbody>
                                            @foreach ($health_certifications as $health_certification)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ isset($health_certification->patient) ? $health_certification->patient->name : '' }}
                                                    </td>
                                                    <td>
                                                        {{ isset($health_certification->medicalService) ? $health_certification->medicalService->name : '' }}
                                                    </td>
                                                    <td>{{ isset($health_certification->consultingRoom) ? $health_certification->consultingRoom->name : '' }}</td>
