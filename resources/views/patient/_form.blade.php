...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="userpassword" placeholder="Nhập mật khẩu" autocomplete="new-password" name="password" required>
...
<button type="submit" value="create" class="btn btn-primary mr-1 waves-effect waves-light">Lưu lại</button>
